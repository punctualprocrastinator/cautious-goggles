...
\bibitem{vishwanath2024vishpred}
Vishwanath, S., et al. (2024). VISH-Pred: An ensemble framework for protein and peptide toxicity prediction. \textit{Briefings in Bioinformatics}, 25(4).

\bibitem{pnas2024peft}
Author, A., et al. (2024). Democratizing Protein Language Models with Parameter-Efficient Fine-Tuning. \textit{PNAS}.
\end{thebibliography}
